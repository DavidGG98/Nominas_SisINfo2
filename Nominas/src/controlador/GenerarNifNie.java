...
public class GenerarNifNie {
    ...
    public  static void main () {
        System.out.println("Revisando los documentos de identidad de los trabajadores");
        readExcelFile();
        System.out.println("Se ha generado un documento XML con los errores encontrados en la carpeta resoures");
    }
     ...
     public static void checkForDuplicates (XSSFSheet sheet) throws ParserConfigurationException, IOException, TransformerException {
        ...
        for(int i=0;i<errores.size();i++) {
            ...
            g.addTrabajador(t, errores.get(i)+1);
